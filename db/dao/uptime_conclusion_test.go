...
func createRandomUptimeConclusion(t * testing.T) UptimeConclusion {
	...
	inuc, err := tq.AddUptimeConclusion(context.Background(), addUptimeConclusionParams{
		UWRId: uc.UWRId,
		SuccessCount: uc.SuccessCount,
		WarningCount: uc.WarningCount,
		ErrorCount: uc.ErrorCount,
		MinResponseTime: uc.MinResponseTime,
		MaxResponseTime: uc.MaxResponseTime,
		AvgSuccessResponseTime: uc.AvgSuccessResponseTime,
		AvgWarningResponseTime: uc.AvgWarningResponseTime,
